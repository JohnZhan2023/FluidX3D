...
void main_setup(){
	...
	for (int object_id = 300; object_id < 330; object_id++){
		run_simulation_2d(si_u, object_id, 0.8f, false, true);
	}
	// run_simulation_2d(si_u, 330, 0.8f, false, true);	
