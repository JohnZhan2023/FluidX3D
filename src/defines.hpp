...
#define GRAPHICS_FRAME_WIDTH 720 // set frame width if only GRAPHICS is enabled
#define GRAPHICS_FRAME_HEIGHT 480 // set frame height if only GRAPHICS is enabled
...
#define GRAPHICS_TRANSPARENCY 0.3f // optional: comment/uncomment this line to disable/enable semi-transparent rendering (looks better but reduces framerate), number represents transparency (equal to 1-opacity) (default: 0.7f)
