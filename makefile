...
bin/FluidX3D: temp/graphics.o temp/info.o temp/kernel.o temp/lbm.o temp/lodepng.o temp/main.o temp/setup.o temp/shapes.o temp/utils.o make.sh
	@mkdir -p bin
...
temp/utils.o: src/utils.cpp src/utils.hpp
	@mkdir -p temp
	$(CC) -c src/utils.cpp -o temp/utils.o $(CFLAGS) $(LDFLAGS_OPENCL)
